...
The water-simulation is implemented leveraging the compute shader. The importent lines are the following:
...
The normals, which are visualized with the aid of a geometry shader, are recalculated after each simulation step. See the following figure.
